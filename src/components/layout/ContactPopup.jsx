...
function ContactPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/70 px-4 py-4" role="dialog" aria-modal="true" aria-labelledby="contact-popup-title">
      <div className="relative max-h-[92svh] w-full max-w-[620px] overflow-y-auto bg-white p-5 shadow-[0_30px_100px_rgba(0,0,0,0.4)] sm:p-6">
        <button
          className="absolute right-4 top-4 grid size-10 place-items-center bg-black text-white transition hover:bg-[var(--color-accent)]"
          type="button"
          onClick={closePopup}
        ...
        <div className="pr-12">
          ...
          <h2 id="contact-popup-title" className="text-2xl font-extrabold leading-tight text-black sm:text-3xl">
            Contact Us
          </h2>
        ...
        <div className="mt-5 border-2 border-black p-5 sm:p-6">
